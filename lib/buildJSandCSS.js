...
import defalutInjector from './defaultInjector';
...
function insertJSandCSS(buffers, injector) {
  ...
  const injected = injector ? injector(pageTpl, assetsURL) : defalutInjector(pageTpl, assetsURL);
...
export default function buildJSandCSS(components, injector, buildOption) {
  ({
    srcPath,
    builtJSPath,
    builtCSSPath,
